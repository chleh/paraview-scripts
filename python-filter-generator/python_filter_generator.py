...
<CustomFilterDefinitions>
  <CustomProxyDefinition name="{pn}" group="{pg}">
    <SourceProxy name="{pn}" class="vtkPythonProgrammableFilter" label="{pl}">
...
{sp}
      ...
      '''.format(
              ...
              lh = longHelp,
              sh = shortHelp,
              ipx = inputPropertyXml,
              fps = filterProperties,
              ex = extraXml,
              odt = outputDataSetType,
              sp = scriptProperties)
